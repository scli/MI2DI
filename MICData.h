...
class MICData
{
    ...
    public:
     ...
     void dim(int * d)            { mDim = d;       }
     void offset(int * o)         { mOffset = o;    }
     ...
     int numClus()     { return mNumClus; }
     int numCols()     { return mNumCols; }
    ...
    // double** getCovMat()                { return mCovMat; } 
     ...
     virtual double similarity(DisDataT* data1, DisDataT* data2) { return 0.0; }
     virtual double similarity(int index1, int index2) { return 0.0; }
     virtual int    getIndex  (int index, DisDataT data) { return 0; }
     virtual int    getIndex  (int index, int row) { return 0; }
     virtual double getValue  (int index, int row) { return 0.0; }
     virtual double localSingularSimilarity(int pos,  int a1, int b1, double identity) { return 0.0;}
     virtual double localPairSimilarity(int pos1, int pos2, int a1, int a2, int b1, int b2, double identity) { return 0.0;}
